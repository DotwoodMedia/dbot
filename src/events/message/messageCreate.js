...
module.exports = async (client, message) => {
  ...
  if (message.channel.type === "DM") {
    let embedLogs = new Discord.MessageEmbed()
      ...
      .setDescription(`Dbot has received a new DM message!`)
          ...
          fields: [
           {
            ...
            {
              name: "📨┆Invite me",
              value: `Invite Dbot in your own server! [Click here](${client.config.discord.botInvite})`,
            },
            {
  ...
  if (command) {
    ...
    client.embed(
      {
        title: "👋・Hi, i'm Dbot",
        desc: `Dbot is now completely in ${client.emotes.normal.slash} commands. The current message commands have expired! Try our new improved commands and make your server better with Dbot!`,
        fields: [
           {
                name: "📢┇Alert!",
                value: 'After more than 1 year we decided to stop Dbot on April 15th, for more information go to [this server](https://discord.gg/techpoint)',
