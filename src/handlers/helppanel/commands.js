...
module.exports = async (client) => {
    ...
    client.on('interactionCreate', async (interaction) => {
        ...
        if (interaction.customId == "dbot-helppanel") {
            if (interaction.values == "commands-dbothelp") {
                ...
                client.embed({
                    title: `❓・Help panel`,
                    desc: `View all command categories in the bot here! \n\n[Website](https://dotwood.media/dbot) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/798144456528363550/vote)`,
