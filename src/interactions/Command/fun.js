...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('fun')
        .setDescription('Run fun commands in Dbot')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('meme')
                .setDescription('See all the fun meme commands in Dbot')
                .addSubcommand(subcommand =>
                    subcommand
                        .setName('confused')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('user')
                .setDescription('See all the fun user commands in Dbot')
                .addSubcommand(subcommand =>
                    subcommand
                        .setName('hack')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('text')
                .setDescription('See all the fun text commands in Dbot')
                .addSubcommand(subcommand =>
                    subcommand
                        .setName('ascii')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('extra')
                .setDescription('See all the fun extra commands in Dbot')
                .addSubcommand(subcommand =>
                    subcommand
                        .setName('birdfact')
