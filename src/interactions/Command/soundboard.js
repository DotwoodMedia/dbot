...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('soundboard')
        .setDescription('Play all the sounds in Dbot')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('windows')
                .setDescription('Play the windows sounds in Dbot')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('earrape')
                .setDescription('Play the earrape sounds in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('reee')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('songs')
                .setDescription('Play the song sounds in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('dancememe')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('discord')
                .setDescription('Play the discord sounds in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('discordcall')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('memes')
                .setDescription('Play the meme sounds in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('fbi')
