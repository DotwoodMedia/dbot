    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('message')
                ...
                .addChoice('Dbot-Info', 'botinfo')
                .addChoice('Dbot-Badges', 'badges')
                .addChoice('Dbot-Béta', 'beta')
                .addChoice('Dbot-Credits', 'credits')
        )
    ,
    ...
    run: async (client, interaction, args) => {
        ...
        model.findOne({ User: interaction.user.id }, async (err, data) => {
            if (data && data.FLAGS.includes("DEVELOPER")) {
                ...
                if (message == "information") {
                    client.simpleEmbed({
                        ...
                        client.embed({
                            ...
                            thumbnail: "https://media.discordapp.net/attachments/937337957419999272/937463192265846784/techpoint_logo_dbot.jpg?width=812&height=812",
                            fields: [
                                {
                                    name: `👋┆Welcome to Dbot Support!`,
                                    value: `Welcome to your support server! We focus on our bots Dbot & Dbot 2. Stay up to date, ask your questions and test out our bots.`,
                                },
                                {
                        ...
                        client.embed({
                            ...
                            fields: [
                                ...
                                },
                                {
                                    ...
                                    value: `Get access to unreleased Dbot features with your own server! You are a real Dbot tester!`,
                                },
                                {
                                ...
                                {
                                    name: `📖┆Learn and grow`,
                                    value: `We understand that you don't always understand everything right away! At Dbot, we give you the opportunity to learn new things and get better at the position. You can also grow into the management team in the future!`,
                                },
                                {
                ...
                if (message == "botinfo") {
                    client.simpleEmbed({
                        image: `https://media.discordapp.net/attachments/937337957419999272/938725909668691978/techpoint_channel_banner_dbot.jpg?width=812&height=221`
                    }, interaction.channel).then(() => {
                        client.embed({
                            title: `ℹ・Dbot(s) Information`,
                            author: {
                                name: "TechPoint",
                                iconURL: "https://media.discordapp.net/attachments/937337957419999272/937797574440681472/techpoint_logo-min.jpg?width=812&height=812"
                            },
                            ...
                            fields: [
                                {
                                    name: `🤖┆What is Dbot?`,
                                    value: `Dbot is a bot with which you can run your entire server! With no less than 400+ commands, we have a large bot with many options to improve your server and the best part is that it is completely in slash commands! You know what else is beautiful? All of this is **FREE** to use!`,
                                },
                                {
                                    name: `🎶┆What is Dbot 2?`,
                                    value: `Dbot 2 was created for additional music. This way you never get in each other's way when someone is already listening to music. Furthermore, this bot contains a soundboard and a radio system and the best part is that it is completely in slash commands!`,
                                },
                                {
                                    name: `📨┆How do I invite the bots?`,
                                    value: `You can invite the bots by doing \`/invite\` or by clicking on the links below\n\n**Dbot Invite** - [Invite Here](https://discord.com/oauth2/authorize?&client_id=798144456528363550&scope=applications.commands+bot&permissions=8)\n**Dbot 2 Invite** - [Invite Here](${client.config.discord.botInvite})`,
                                },
                                {
                ...
                if (message == "badges") {
                    ...
                    //         desc: `We at Dbot have a special badge system! You can find your badge via the userinfo command. Read below what each badge means`,
                    //         fields: [
                    //             {
                    //                 name: `${client.emotes.badges.bot}┆Bot badge`,
                    //                 value: `This badge is only available for the Dbot(s). This way you can see even better that they belong together.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.developer}┆Developer badge`,
                    //                 value: `This badge is only available to Dbot developers. This shows that they are official developers of the bots.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.management}┆Management badge`,
                    //                 value: `You can get this badge if you are an official management member of team Dbot.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.team}┆Team badge`,
                    //                 value: `You can get this badge if you are an official team member of team Dbot.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.support}┆Support badge`,
                    //                 value: `You can get this badge if you are an official support member of team Dbot.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.moderator}┆Moderator badge`,
                    //                 value: `You can get this badge if you are an official moderator of team Dbot.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.marketing}┆Marketing badge`,
                    //                 value: `You can get this badge if you are an official marketing member of team Dbot.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.event}┆Organization badge`,
                    //                 value: `You can get this badge if you are an official organization member of team Dbot.`,
                    //             },
                    //             {
                    //                 name: `${client.emotes.badges.designer}┆Designer badge`,
                    //                 value: `You can get this badge if you are an official designer of team Dbot.`,
                    //             },
                    //             {
                    ...
                    //                 value: `You can get this badge if you have given something to Dbot to improve the bot even more.`,
                    //             },
                    //             {
                ...
                if (message == "beta") {
                    client.simpleEmbed({
                        ...
                        client.embed({
                            ...
                            thumbnail: "https://media.discordapp.net/attachments/937337957419999272/937463192265846784/techpoint_logo_dbot.jpg?width=812&height=812",
                            desc: `The Dbot Beta program is a program for new updates that still contains some bugs. Because of this program there are fewer bugs at the release! Everything happens via another bot so that the current bot users are not bothered by the beta testing`,
                            fields: [
                                {
                                    name: `📃┆Requirements for participation`,
                                    value: `- Minimum 50 members in the server \n- No test servers \n- Following the Discord and Dbot TOS \n- Active server`,
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: `Nice that you want to participate in Dbot! We ask you to create a ticket in us <#897213893624102965> We will send a form and possibly additional information \n\n**Pay attention!** When the update is out you will be removed from our program!`,
                                }
                            ],
                            footer: {
                                text: `© TechPoint - 2022`,
                        ...
                        client.embed({
                            ...
                            fields: [
                                ...
                                },
                                {
                                    ...
                                    value: `Currently you only get Dcredits when you vote on Dbot. You can do this on top.gg! The credits will then be automatically added to your account!`,
                                },
                                {
                                    name: `💱┆What can you exchange Dcredits for?`,
                                    value: `- Dbot background pack (8 credits per pack)\n- Dbot logo pack (6 credits per pack)\n- Dbot sticker pack (5 credits per pack)\n- Dbot 1 year pack (10 credits per pack)`,
                                },
                                {
                ...
                return client.errNormal({ text: "Only Dbot 2 developers are allowed to do this", editreply: true }, interaction);
            }
        })
    },
};
