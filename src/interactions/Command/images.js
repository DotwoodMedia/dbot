...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('images')
        .setDescription('See all the images in Dbot')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('memes')
                .setDescription('See all the memes in Dbot')
                .addSubcommand((subcommand) =>
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('animals')
                .setDescription('See all the animal images in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('bird')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('user')
                .setDescription('See all the user images in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('ad')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('extra')
                .setDescription('See all the extra images in Dbot')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('car')
