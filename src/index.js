...
console.log(`\u001b[0m`)
console.log(chalk.red(`© Dotwood Media | 2021 - ${new Date().getFullYear()}`))
console.log(chalk.red(`All rights reserved`))
console.log(`\u001b[0m`)
console.log(chalk.red(`Developed by`), (chalk.white(`</Pascal>#0001`)), (chalk.red(`&`)), (chalk.white(`</Brammo>#1406`)))
console.log(`\u001b[0m`)
