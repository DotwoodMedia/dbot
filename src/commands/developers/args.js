...
module.exports = async (client, interaction, args) => {
    ...
    if (message == "information") {
        client.simpleEmbed({
            image: `https://cdn.discordapp.com/attachments/843487478881976381/874742689017520128/dbot_banner_information.jpg`
            ...
            client.embed({
                ...
                fields: [
                    ...
                    {
                        name: `⚙️┆I want to help Dbot Hangout to improve!`,
    ...
    if (message == "rules") {
        client.simpleEmbed({
            image: `https://cdn.discordapp.com/attachments/843487478881976381/874742702393131038/dbot_banner_rules.jpg`
    ...
    if (message == "applications") {
        client.simpleEmbed({
            image: `https://cdn.discordapp.com/attachments/843487478881976381/874742737415581786/dbot_banner_applications.jpg`
        }, interaction.channel).then(() => {
            client.embed({
                title: `💼・Applications`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                ...
                fields: [
                    {
                        ...
                        value: `In the Dbot team there is always a pleasant atmosphere and everyone is treated equally!`,
                    },
                    {
    ...
    if (message == "boosterperks") {
        client.simpleEmbed({
            image: `https://media.discordapp.net/attachments/843487478881976381/881396544195149874/dbot_banner_boosters.jpg`
        }, interaction.channel).then(() => {
            client.embed({
                title: `💎・Booster Perks`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                desc: `_____ \n\nMore options in the server? Become a real Dbot Booster and get nice benefits for a nice experience. But what do you actually get?`,
                fields: [
                    {
                    ...
                    {
                        name: `💻┆Access to new bèta updates in Dbot`,
    ...
    if (message == "links") {
        client.simpleEmbed({
            ...
            client.embed({
                title: `🔗・Links`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                desc: `_____ \n\nSee all the links from Dbot Network!`,
                fields: [
                    {
                        name: `▬▬│Servers│▬▬`,
                        value: `> **Community server** \nhttps://discord.gg/dbot \n\n> **Ban Appeal** \nhttps://discord.gg/htf9pHNRxA \n\n> **Support server** \nhttps://discord.gg/3SJMZdUgfG\n`,
                    },
                    {
                        name: `▬▬│Packages│▬▬`,
                        value: `> **Dotwood.js** \nhttps://www.npmjs.com/package/dotwood.js \n\n> **Dotwood.js radio (discord.js v12)** \nhttps://www.npmjs.com/package/dotwood.js-radio \n\n> **Top.gg votes** \nhttps://www.npmjs.com/package/topgg-votes \n\n> **Easy shorten url** \nhttps://www.npmjs.com/package/easy-shorten-url \n\n> **Minecraft server stats** \nhttps://www.npmjs.com/package/minecraft-server-stats`,
                    },
                    {
                        name: `▬▬│Documentation│▬▬`,
                        value: `https://docs.dotwood.media/`,
                    }
                ]
            }, interaction.channel)
        })
    ...
    if (message == "ourbots") {
        client.simpleEmbed({
            image: `https://cdn.discordapp.com/attachments/843487478881976381/874742741224022016/dbot_banner_bot_info.jpg`
        }, interaction.channel).then(() => {
            client.embed({
                title: `🤖・Our bots`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                ...
                fields: [
                    {
                        name: `📘┆What is Dbot?`,
                        value: `Dbot is a bot with which you can run your entire server! With no less than 400+ commands, we have a large bot with many options to improve your server! You know what else is beautiful? All of this is **FREE** to use!`,
                    },
                    {
                        name: `🎶┆What is Dbot 2?`,
                        value: `Dbot 2 was created for additional music. This way you never get in each other's way when someone is already listening to music. Furthermore, this bot contains a soundboard and a radio system`,
                    },
                    {
                        name: `📨┆How do I invite the bots?`,
                        value: `You can invite the bots by doing \`/invite\` or by clicking on the links below \n\n**Dbot** - [Invite here](https://discord.com/oauth2/authorize?&client_id=798144456528363550&scope=applications.commands+bot&permissions=8) \n**Dbot 2** - [Invite here](https://discord.com/oauth2/authorize?&client_id=896842236002713673&scope=applications.commands+bot&permissions=8)`,
                    },
                    {
                        name: `🎫┆How do I get help when needed?`,
                        value: `You can make a ticket in <#820308164322656327>! We are happy to help you with your questions here and offer support in your server!`,
